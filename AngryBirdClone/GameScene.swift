...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    //aşağıdaki sayılar verilirken en son sayının bir öncekilerin toplamından büyük olması gerekiyor
    ...
    //açılınca bir kere çalışan fonksiyon
    override func didMove(to view: SKView) {
        //kod ile nesne ekleme
        ...
        //yerçekiminden etkileniyor mu?
        bird.physicsBody?.affectedByGravity = false
        //fizik dinamiklerinden etkileniyor mu?
        bird.physicsBody?.isDynamic = true
        //ağırlığı ne kadar(kg cinsinden)
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        if let birdPhysicsBody = bird.physicsBody {
            if birdPhysicsBody.velocity.dx <= 0.1 && birdPhysicsBody.velocity.dy <= 0.1 && bird.physicsBody!.angularVelocity <= 0.1 && gameStarted == true {
